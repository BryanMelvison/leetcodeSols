class Solution:
    def fib(self, n: int) -> int:
        ...
        # Notice pattern is fibonacci sequence, we can use two variables to keep track of the previous
        # two stairs and update them as we iterate through the list.
        # Time complexity: O(n), where n is the number of stairs, we visit each
        # stair once.
